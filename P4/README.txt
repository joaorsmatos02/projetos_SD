...
Utilizamos o tree.o fornecido pelos professores, basta colocá-lo nas pasta object.
...
Execução tree-server: ./tree-server (serverport) (zookeeperip:zookeeperport)

Execução tree-client: ./tree-client (zookeeperip:zookeeperport) 
